...
These settings apply only when `--tag=package-4323-32` is specified on the command line.

```yaml $(tag) == 'package-4323-32'
input-file:
  - Microsoft.AnalysisServices/stable/4323-32-43/analysisservices.json
```
### Tag: package-2017-08
