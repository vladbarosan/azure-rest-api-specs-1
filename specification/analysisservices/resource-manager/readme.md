...
These settings apply only when `--tag=package-3412-32` is specified on the command line.

```yaml $(tag) == 'package-3412-32'
input-file:
  - Microsoft.AnalysisServices/stable/3412-32-32/analysisservices.json
```
### Tag: package-2017-08
