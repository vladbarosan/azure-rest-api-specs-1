...
These settings apply only when `--tag=package-3123-21` is specified on the command line.

```yaml $(tag) == 'package-3123-21'
input-file:
  - Microsoft.ContainerRegistry/stable/3123-21-21/containerregistry.json
```
